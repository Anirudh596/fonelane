...
function CardContent({pIndex}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
       try {
        const res = await axios.get(`http://ec2-35-154-21-93.ap-south-1.compute.amazonaws.com:1337/api/deal-of-the-day-2s/${pIndex}?populate=*`, {
          headers: {
  ...
  useEffect(() => {
    const fetchData = async ()=>{
      try {
          const res = await axios.get(`http://ec2-35-154-21-93.ap-south-1.compute.amazonaws.com:1337/api/deal-of-the-day-2s/${pIndex}`, {
          headers: {
            Authorization: "bearer "+ "",
          }
        }
