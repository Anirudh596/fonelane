...
function CardContent({pIndex}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
       try {
        const res = await axios.get(`http://3.110.62.60:1337/api/deal-of-the-day-2s/${pIndex}?populate=*`, {
          headers: {
  ...
  useEffect(() => {
    const fetchData = async ()=>{
      try {
          const res = await axios.get(`http://3.110.62.60:1337/api/deal-of-the-day-2s/${pIndex}`, {
          headers: {
            Authorization: "bearer "+ "",
          }
        }
