          ...
          {isSidebarOpen && ( // Conditionally render the sidebar content
            <>
              ...
              <BackBtn func={handleSidebarOptionClick} className={"left-0 m-5 text-base "}/>
                <ul className="p-4">
                  <li className="my-2 flex items-center justify-center">About Us</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Track Order</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Help</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Verified Refurbished</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Student Special</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Deals</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">iPhone</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">OnePlus</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">Samasung Galaxy</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">MI</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">VIVO</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                  <li className="my-2 flex items-center justify-center">OPPO</li>
                  <hr className="h-px border-0 my-1 bg-gray-200"/>
                </ul>
              </div>
            </>
