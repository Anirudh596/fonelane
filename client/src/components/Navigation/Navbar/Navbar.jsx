      ...
      <div className="sticky top-0 bg-white z-50 w-full ">
        <div className="mx-auto h-[40px] md:h-[50px] lg:h-[60px] xl:h-[70px] flex justify-around items-center">
          ...
          <Search />
            ...
            <CiSearch className="text-xs md:text-xs lg:text-sm xl:text-2xl 2xl:text-2xl right-3 block md:hidden "/>
          <div className="flex justify-between items-center text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-3xl gap-2 md:gap-10">
            ...
            <button className="px-1 py-.5  md:px-3 md:py-2 border border-black rounded-sm md:rounded-md lg:rounded-md xl:rounded-lg active:bg-black active:text-white hover:bg-gray-200 text-xs md:text-xs lg:text-sm xl:text-sm hover:scale-105">Login </button>
          </div>
          <div className=" flex md:hidden justify-between items-center text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-3xl ">
            <button onClick={toggleBars}><HiBars3BottomRight /></button>
          </div>
        </div>
      </div>
      <div>
