...
function ProductSection() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`http://ec2-35-154-21-93.ap-south-1.compute.amazonaws.com:1337/api/deal-of-the-day-2s/${id}?populate=*`, {
          headers: {
    ...
    const fetchData = async () => {
      try {
        const axiosInstance = axios.create({
          baseURL: "http://ec2-35-154-21-93.ap-south-1.compute.amazonaws.com:1337/api/deal-of-the-day-2s",
          headers: {
            Authorization: "bearer " + "",
          },
        });
