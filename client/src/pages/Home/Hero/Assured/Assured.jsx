  ...
  return (
    <div className="w-full mx-auto my-5">
      <div className="flex justify-between items-center">
        <div className="mx-2 md:mx-5 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          <img
            ...
            className="mx-2 md:mx-5 w-[20px] h-[30px] md:w-[30px] md:h-[40px] lg:w-[50px] lg:h-[40px] xl:w-[50px] xl:h-[60px] "
          />
          <p className="text-[8px] md:text-xs lg:text-xs xl:text-base">
            Cash On Delivery
          </p>
        ...
        <div className="mx-2 md:mx-5 hidden md:flex md:flex-col justify-center items-center">
