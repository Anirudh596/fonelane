  ...
  return (
    ...
    <div className="flex-col-reverse justify-center items-center ">
        ...
        <div className="px-5">
            ...
            <p className="title w-full text-inherit flex gap-5 text-sm md:text-base lg:text-xl xl:text-2xl font-medium justify-center items-center" >₹9,999 <p className="flex text-sm md:text-base lg:text-xl xl:text-2xl gap-1 font-normal">M.R.P: <p className="line-through">24,999</p></p></p>
