      ...
      <div className="sticky md:sticky lg:sticky xl:sticky top-0 md:top-0 lg:top-0 xl:top-0 bg-white z-50 w-full">
        <div className="mx-5 navbar h-[35px] md:h-[45px] lg:h-[50px] xl:h-[55px] flex justify-between items-center ">
          ...
          <div className="w-full flex  justify-between items-center  gap-32">
            ...
            <div className="hidden md:hidden lg:flex xl:flex  justify-between items-center">
              <ul className="w-full flex  text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px] list-none  flex-nowrap justify-between gap-3 items-center">
                <Link>
                  <li className="flex flex-nowrap">About Us</li>
                </Link>
                <Link>
                  <li className=" flex flex-nowrap">Contact Us</li>
                </Link>
              </ul>
